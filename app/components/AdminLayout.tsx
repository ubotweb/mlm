...
export const AdminLayout: FC<{ profile: any; activeMenu: string; children: any }> = ({ profile, activeMenu, children }) => {
  ...
  const menus = [
    ...
    { name: 'Kelola Paket MLM', path: '/admin/paket', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
