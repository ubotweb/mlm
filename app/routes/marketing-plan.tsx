...
export default createRoute(async (c) => {
  ...
  try {
    ...
    return c.render(
      <PublicLayout waLink={waLink} activeMenu="plan">
        
        {/* Hero Section Marketing Plan */}
        ...
        <section class="bg-[#151921] py-16 md:py-20 border-y border-[#222731]">
          <div class="container mx-auto px-6">
            <div class="text-center mb-12">
              ...
              <p class="text-[#8B949E] text-sm font-medium">Bonus instan yang dibayarkan real-time (per detik) setiap kali jaringan Anda bertumbuh hingga kedalaman 5 generasi.</p>
            </div>
        ...
        {/* Section Bonus Cash Back & Auto RO */}
        ...
        {/* Section Reward Peringkat Fisik */}
        <section class="py-16 md:py-24">
          <div class="container mx-auto px-6">
            <div class="text-center mb-12">
    ...
    return c.render(
      <div class="min-h-screen bg-[#0B0E14] text-white p-10 text-center font-sans flex flex-col items-center justify-center">
        ...
        <a href="/" class="bg-blue-600 hover:bg-blue-500 text-white px-8 py-3 rounded-xl font-bold text-sm transition-all shadow-lg">Kembali ke Beranda</a>
      </div>
    )
  }
})
