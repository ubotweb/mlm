...
export default createRoute(async (c) => {
  ...
  let waLink = ''
  // Default Sticky WA jika tidak ada link referral (Bisa diisi nomor Admin Pusat)
  let stickyWaLink = 'https://wa.me/6280000000000?text=Halo%20Admin%20HMM%20Beauty' 
    ...
    <div class="min-h-screen bg-[#0B0E14] text-white font-sans selection:bg-emerald-500/30">
      ...
      <header class="container mx-auto px-4 md:px-6 py-6 flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
        ...
        <div class="flex items-center space-x-3 md:space-x-4">
          ...
          <a href={waLink || "/register"} class="bg-emerald-500 hover:bg-emerald-600 text-[#0B0E14] px-4 py-2 md:px-5 md:py-2.5 rounded-full font-black transition-all shadow-lg shadow-emerald-500/20 uppercase tracking-wider text-xs md:text-sm whitespace-nowrap">
            Daftar Kemitraan
          </a>
        </div>
      </header>
        ...
        <div class="container mx-auto px-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-[#1A1E26] border border-[#2D3342] p-8 rounded-2xl hover:border-emerald-500 transition-all text-center">
              ...
              <a href={waLink || "/register?paket=starter"} class="block w-full bg-[#2D3342] hover:bg-emerald-500 hover:text-[#0B0E14] text-white py-3 rounded-lg font-bold transition-colors">Pilih Starter</a>
            </div>
            ...
            <div class="bg-[#1A1E26] border border-[#2D3342] p-8 rounded-2xl hover:border-emerald-500 transition-all text-center">
              ...
              <a href={waLink || "/register?paket=silver"} class="block w-full bg-[#2D3342] hover:bg-emerald-500 hover:text-[#0B0E14] text-white py-3 rounded-lg font-bold transition-colors">Pilih Silver</a>
            </div>
            ...
            <div class="bg-[#1A1E26] border-2 border-blue-500 p-8 rounded-2xl relative text-center transform md:-translate-y-4 shadow-2xl shadow-blue-500/20">
              ...
              <a href={waLink || "/register?paket=gold"} class="block w-full bg-blue-600 hover:bg-blue-500 text-white py-3 rounded-lg font-bold transition-all shadow-lg">Pilih Gold</a>
            </div>
            ...
            <div class="bg-[#1A1E26] border border-[#2D3342] p-8 rounded-2xl hover:border-emerald-500 transition-all text-center">
              ...
              <a href={waLink || "/register?paket=platinum"} class="block w-full bg-[#2D3342] hover:bg-emerald-500 hover:text-[#0B0E14] text-white py-3 rounded-lg font-bold transition-colors">Pilih Platinum</a>
            </div>
                ...
                <dialog id={`modal-${p.id}`} class="bg-transparent m-auto p-0 w-[95vw] max-w-4xl backdrop:bg-[#0B0E14]/90 backdrop:backdrop-blur-sm rounded-2xl open:animate-in open:fade-in-0 open:zoom-in-95">
                  <div class="bg-[#151921] border border-[#222731] rounded-2xl overflow-hidden shadow-2xl relative flex flex-col md:flex-row text-left">
                    ...
                    <div class="w-full md:w-3/5 p-6 md:p-10 flex flex-col">
                      ...
                      <a href={waLink || "/login"} class="w-full text-center bg-blue-600 hover:bg-blue-500 text-white font-black py-4 rounded-xl transition-all shadow-lg shadow-blue-600/20 uppercase tracking-widest text-sm">
      ...
      <a href={stickyWaLink} target="_blank" class="fixed bottom-6 right-6 bg-[#25D366] text-white p-4 rounded-full shadow-[0_4px_15px_rgba(37,211,102,0.4)] hover:bg-[#128C7E] hover:scale-110 transition-all z-50 flex items-center justify-center animate-bounce">
