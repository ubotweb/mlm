...
export default createRoute(async (c) => {
  ...
  // PERBAIKAN: Mengambil nama asli, HU ID, dan saldo menggunakan kolom hu_id
    ...
    <MemberLayout profile={profile} balance={balance} activeMenu="Dashboard">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-[#151921] border border-[#222731] rounded-2xl p-6 shadow-sm flex items-center">
          ...
          <div>
            <p class="text-[11px] font-black text-[#8B949E] uppercase tracking-widest mb-1">Pasangan Kiri</p>
        ...
        <div class="bg-[#151921] border border-[#222731] rounded-2xl p-6 shadow-sm flex items-center">
          ...
          <div>
            <p class="text-[11px] font-black text-[#8B949E] uppercase tracking-widest mb-1">Pasangan Kanan</p>
            <h4 class="text-2xl font-black text-white">0</h4>
          </div>
        </div>
      </div>
